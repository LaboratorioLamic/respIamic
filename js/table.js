        ...
        tr.innerHTML = `
            ...
            <td class="p-5">
                <div class="flex justify-center gap-2">
                    ...
                    <button onclick="editRecord(${app.id})" class="h-8 w-8 rounded-lg flex items-center justify-center text-slate-400 border border-slate-100 hover:bg-navy-900 hover:text-white transition-all"><i class="fas fa-edit"></i></button>
